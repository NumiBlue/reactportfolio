...
const Portfolio = () => {
  return (
    <div
      name="portfolio"
      className="w-full md:h-screen text-b[#1616D] bg-amber-100"
    >
      <div className="max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full">
        ...
        {/* Container */}
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 space-x-4">
          {/* Grid Item */}
          <div
          ...
          <div
            ...
            className="shadow-lg shadow-[#040c16] group container rounded-md flex justify-center items-center content-div m-2"
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100">
              <span className="text-2xl font-bold text-white tracking-wider">
